<div id="Subheader" style="background-image:url(<?= URL; ?>public/images/header/<?= $this->nosotros['imagen_header']; ?>); background-repeat:no-repeat; background-position:center; background-attachment:fixed; -webkit-background-size:cover; background-size:cover">
    <div class="container">
